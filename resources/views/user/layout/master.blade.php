...
<head>
	...
	<link rel="shortcut icon" type="image/png" href="user/img/logomy.jpg"/>
	<!-- The above 3 meta tags *must* come first in the head; any other head content must come *after* these tags -->
	
	<title>Cosmetic_Shop</title>
						...
						<div class="col-md-3">
							<div class="header-logo">
								...
								<a href="{{route('user.home')}}" class="logo">
									<img style="width:70px;" src="{{asset("user/img/logomy.jpg")}}" alt="">
						...
						<div class="col-md-6">
							<div class="header-search">
								<form action="{{route('user.home')}}" method="GET">
									@method('GET')
									@csrf
									<input type="text" name="product_search" id="product_search" class="input" placeholder="Tìm kiếm mỹ phẩm!!" style="border-radius: 5px 0px 0px 5px;">
								...
								<!-- Account -->
									<div class="dropdown"     style="color:#FFFFFF">
										...
										<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
											...
											<a class="dropdown-item"  href="{{ route('user.Account') }}">Đăng Nhập</a><br>
											<a class="dropdown-item" href="{{ route('auth.loginadmin') }}">Admin</a>
										</div>
									</div>
						...
						<div class="col-md-3 col-xs-6">
							<div class="footer">
								...
								<ul class="footer-links">
									<li><a href="#"><i class="fa fa-map-marker"></i>137 nguyễn thị thập, Liên Chiểu</a></li>
