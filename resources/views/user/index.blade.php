					...
					<div class="col">
						<div class="carousel-inner">
							<div class="item active ">
								<img width="100%"  height="500px" src="{{asset("/user/img/ban.png")}}" class="img-rounded"  alt="banner 1" >
							</div>

							<div class="item">
								<img width="100%"  height="500px" src="{{asset("/user/img/banner2.jpg")}}" class="img-rounded"  alt="banner 2" >
							</div>

							<div class="item">
								<img width="100%"  height="500px" src="{{asset("/user/img/ban.png")}}" class="img-rounded"  alt="banner 3" >
							</div>
						</div>
					</div> 		
				</div>
